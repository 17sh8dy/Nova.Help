...
-- Profile pictures: a reference to an R2 object, never the image itself. Added by
-- migrations/0001_account_avatars.sql, which is the same statement for a live database.
